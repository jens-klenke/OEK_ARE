...
- Use `across()` to summarise on specific columns.
...
- Inside the `across()` function we can use the helper function for select which we already saw in the previous slides. 
