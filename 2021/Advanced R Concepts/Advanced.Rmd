...
Explain why modifying a row of a data frame generally is more costly than changing a column.
]]
...
.blockquote.exercise[
#### `r desktop` Example: primitives vs. regular functions
...
.blockquote.exercise[
#### `r desktop` Example: fun with anonymous functions
...
.blockquote.exercise[
#### `r desktop` Example: replacement of last vector element
